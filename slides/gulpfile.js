...
gulp.task('css-boosted-font', () => gulp.src(['node_modules/boosted/dist/fonts/*.{ttf,woff2}'])
    .pipe(gulp.dest('./dist/boosted/fonts')))

gulp.task('css-boosted', () => gulp.src(['node_modules/boosted/dist/css/*.css'])
    .pipe(gulp.dest('./dist/boosted/css')))

gulp.task('css-orange-boilerplate', () => gulp.src(['css/orange-boilerplate.scss'])
    .pipe(compileSass())
    .pipe(gulp.dest('./dist')))

gulp.task('css-fontawesome', () => gulp.src(['node_modules/@fortawesome/fontawesome-free/css/all.min.css'])
    .pipe(gulp.dest('./dist/fontawesome/css')))

gulp.task('css-fontawesome-font', () => gulp.src(['node_modules/@fortawesome/fontawesome-free/webfonts/*.{ttf,woff2}'])
...
gulp.task('css', gulp.parallel('css-themes', 'css-core', 'css-fontawesome-font', 'css-fontawesome', 'css-boosted-font', 'css-boosted', 'css-orange-boilerplate'))
